...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { content: @complaint.content, restaurant_id: @complaint.restaurant_id, user_id: @complaint.user_id }
    end
  ...
  test "should update complaint" do
    put :update, id: @complaint, complaint: { content: @complaint.content, restaurant_id: @complaint.restaurant_id, user_id: @complaint.user_id }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
